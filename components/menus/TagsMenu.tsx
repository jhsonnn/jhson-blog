...
//   return (
//     <div className="font-bold gap-5 flex flex-col sm:flex-row md:flex-row lg:flex-col lg:space-x-0 sm:space-x-4">
//       {tags.map((tag) => (
//         <button
//           key={tag}
//           onClick={() => handleTagClick(tag)}
//           className={`hover:text-amber-400 cursor-pointer mb-1 font-medium ${
//             searchParams.get('tag') === tag ? 'bg-gray-300 rounded-xl' : ''
//           }`}
//         >
//           {tag}
//         </button>
